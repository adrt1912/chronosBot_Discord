...
public class ComandoTransferir implements Comando {
    ...
    public void ejecutar(ContextoComando ctx) {
        ...
        String idReceptor=ctx.getParametroString(PARAM_USUARIO);
        ...
        else if (ctx.getParametroUser(PARAM_USUARIO).isBot()) ctx.responder("🤖 **Operación Cancelada** | ¿Intentas enviarle dinero a un bot? Ellos se alimentan de electricidad, no de monedas.");
    ...
    public SlashCommandData getDatosComando() {
        return Commands.slash("transferir", "Transfiere una cantidad de tus monedas a otro usuario.")
                .addOption(OptionType.USER, PARAM_USUARIO, "El usuario que recibirá las monedas.", true)
