...
import aperez.LectorDeComandos;
...
public class ComandoAyuda implements Comando {
    ...
    private static final String PARAM_NOTIFICACIONES="Notificaciones";
    private static final String PARAM_ECONOMIA="Economia";
    private static final String PARAM_CASINO="Casino";
    private static final String PARAM_EXPERIENCIA="Experiencia";
    ...
    public void ejecutar(ContextoComando ctx) {
        ...
        categorias.put(PARAM_NOTIFICACIONES, new StringBuilder("📅 **NOTIFICACIONES Y EVENTOS**\n"));
        categorias.put(PARAM_ECONOMIA, new StringBuilder("💰 **ECONOMÍA Y BIFURCACIONES**\n"));
        categorias.put(PARAM_CASINO, new StringBuilder("🎰 **CASINO Y JUEGOS**\n"));
        categorias.put(PARAM_EXPERIENCIA, new StringBuilder("📈 **SISTEMA DE XP Y NIVELES**\n"));
        ...
        for (Comando cmd : lector.getMapComandos().values()) {
            ...
            if (rutaPaquete.contains(PARAM_NOTIFICACIONES)) claveCategoria = PARAM_NOTIFICACIONES;
            else if (rutaPaquete.contains(PARAM_ECONOMIA)) claveCategoria = PARAM_ECONOMIA;
            else if (rutaPaquete.contains(PARAM_CASINO)) claveCategoria = PARAM_CASINO;
            else if (rutaPaquete.contains(PARAM_EXPERIENCIA)) claveCategoria = PARAM_EXPERIENCIA;
