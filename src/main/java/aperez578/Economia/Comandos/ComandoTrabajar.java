...
public class ComandoTrabajar implements Comando {
    ...
    public void ejecutar(ContextoComando ctx) {
        ...
        long[] user=ConexionBD.getConexionBD().obtenerPerfilEconomia(userId);
        ...
        if(tiempoAhora-tiempo<tiempoDescanso){
            ...
            boolean exito=ConexionBD.getConexionBD().actualizarEconomia(userId,nuevasMonedas,tiempoAhora);
